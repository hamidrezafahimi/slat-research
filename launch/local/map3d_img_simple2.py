...
def main():
    ...
    metric_depth_path, metric_bg_path, bg_path, color_path, mask_path = sys.argv[1:6]
    ...
    # bg_image = cv2.imread(bg_path, cv2.IMREAD_GRAYSCALE)[200:,:]
    bg_image = None
    ...
    # mapper.process(metric_depth, metric_bg, bg_image.astype(np.float32), color_img, mask_img, 
    #                roll, pitch, yaw, z, 80.0)
    mapper.process(metric_depth, metric_bg, bg_image, color_img, mask_img, roll, pitch, yaw, z, 80.0)
